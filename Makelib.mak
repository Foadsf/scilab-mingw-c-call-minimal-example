...
LIBRARY = libmultiply_doubles
# ------------------------------------------------------
# list of files
FILES_SRC = scilab_native.c
# ------------------------------------------------------
# list of objects file
OBJS = scilab_native.obj
OBJS_WITH_PATH = Release/scilab_native.obj
# ------------------------------------------------------
# added libraries
...
#CC = 
# ------------------------------------------------------
CFLAGS = $(CC_OPTIONS) -D__SCILAB_TOOLBOX__ -DFORDLL  -DNDEBUG -DLIBMULTIPLY_DOUBLES_GW_EXPORTS  
# ------------------------------------------------------
